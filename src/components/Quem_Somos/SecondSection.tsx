...
export function SecondSection() {
    ...
    return (
        <SecondSectionComponent img={secondMaxImg}>
            <VStack as='h2' align={{base:'center', lg:'flex-start'}} spacing={8}>
                ...
                <HStack spacing='8'>
                    <Box>
                        <Text as='p' fontWeight='bold' fontSize='40px' color='#262626'>5%</Text>
                        <Text as='p' fontWeight='normal' fontSize='21px' color='#707070'>Lorem ipsum</Text>
                    </Box>
                    <Divider orientation='vertical' height='84px'></Divider>
                    <Box>
                        <Text as='p' fontWeight='bold' fontSize='40px' color='#262626'>26K</Text>
                        <Text as='p' fontWeight='normal' fontSize='21px' color='#707070'>Lorem ipsum</Text>
                    </Box>
                </HStack>
            </VStack>
