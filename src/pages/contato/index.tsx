    ...
    return (
        <>
            <Box position='relative'>
                ...
                <Flex p='30px' justify="space-evenly" my='100px' flexWrap='wrap' >
                    <VStack spacing='30px' align="start" p='30px' w='540px' height='780' background='white' direction='column' mb={{ base: '50px', xl: '0' }} >
                        <Text color='#305F3C' fontSize='48' fontWeight='bold'>Fale Conosco</Text>
                    ...
                    <VStack spacing='30px' align="start" direction='column' >
                        ...
                        <Flex px='30px' direction='column' justify="center" align="center" maxWidth='540px' height='240px' background='white'>
                            <Text color='#305F3C' fontSize='48' fontWeight='bold'>Manaus</Text>
                        ...
                        <Flex px='30px' direction='column' justify="center" align="center" maxWidth='540px' height='240px' background='white'>
                            <Text color='#305F3C' fontSize='48' fontWeight='bold'>Boa Vista</Text>
                            <Box alignSelf={{ base: 'start', md: 'center' }}>
                        ...
                        <Flex px='30px' direction='column' justify="center" align="center" maxWidth='540px' height='240px' background='white'>
                            <Text color='#305F3C' fontSize='48' fontWeight='bold'>Porto Velho</Text>
                            <Box alignSelf={{ base: 'start', md: 'center' }}>
